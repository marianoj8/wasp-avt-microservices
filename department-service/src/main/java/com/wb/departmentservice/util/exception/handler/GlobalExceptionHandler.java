package com.wb.departmentservice.util.exception.handler;


import com.wb.departmentservice.util.exception.BadRequestException;
import com.wb.departmentservice.util.exception.NotFoundException;
import com.wb.departmentservice.util.exception.details.CustomExceptionDetails;
import com.wb.departmentservice.util.exception.details.ValidationExceptionDetails;
...
//    }
    ...
    public ResponseEntity<CustomExceptionDetails> handlerIllegalStateException(
            @NonNull WebRequest request,
...
//    public ResponseEntity<CustomExceptionDetails> handlerURISyntaxException(
//            @NonNull WebRequest request,
//            @NonNull URISyntaxException ex) {
//
//        return new ResponseEntity<>(
//                CustomExceptionDetails.builder()
//                        .timestamp(LocalDateTime.now())
